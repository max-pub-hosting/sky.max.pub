addSplashScreen = function() {
	...
	if (!bodies.length) return setTimeout(addSplashScreen, 5);
	console.timeEnd('bodyReady');
...
window.addEventListener('WebComponentsReady', function(e) {
	...
	console.log('splash.js: DEL', document.getElementById('splash-js'));
